...
5. To do this:
   ...
   * It might actually be better to use the refseq [A. gossypii genome](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_020184175.1/) since it is chromosome-level.
   ...
   * This took a long time and didnt' finish. minimap2 actually has a specific function for running assembly/genome alignments. `minimap2 -ax asm5 ../snp2024/refs/GCF_020184175.1_ASM2018417v2_genomic.fna.gz Aphis_fabae_JIC1_v2.scaffolds.fa > Afabae.sam`
...
### Interpreting dsuite results
  * Dsuite will output a file that ends in BBAA.txt and one that ends in dmin.txt.
    ...
    * Make a conda environment. `conda create --name dsuite`, `conda activate dsuite`, `conda install numpy pandas matplotlib`
