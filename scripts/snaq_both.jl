...
using Pkg
Pkg.activate("/project/aphid_phylogenomics/becca/.julia/project0")
Pkg.instantiate()
...
using PhyloNetworks
net0 = readTopology("../trees/both_astral_root.tre");
using DataFrames, CSV
df_sp = DataFrame(CSV.File("both_tableCF.csv", pool=false); copycols=false);
