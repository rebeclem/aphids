...
# This script is from the example data from orthofinder. It takes in a fasta file and extracts the longest transcript variant per gene and then runs orthofinder on those files. for f in *fa ; do python primary_transcript.py $f ; done
