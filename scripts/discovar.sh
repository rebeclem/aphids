...
source activate /project/aphid_phylogenomics/yelena/yelenaConda/
#DiscovarDeNovo READS=name1_*_R1_001.fastq,name1_*_R2_001.fastq OUT_DIR=. NUM_THREADS=32 MAX_MEM_GB=100
