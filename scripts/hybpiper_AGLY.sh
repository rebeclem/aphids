...
#SAMPLE=$(sed -n "$SLURM_ARRAY_TASK_ID"p genomelist2.txt)
SAMPLE="other_AGLY_bt3_SRR10355382"
module load miniconda
source activate hybpiper
echo ${SAMPLE}_aa
hybpiper assemble -r ${SAMPLE}*fastq -t_aa targets_aa_OG.fa --cpu 20 --prefix ${SAMPLE}_aa --run_intronerate --diamond
