...
echo ${SAMPLE}_COI
hybpiper assemble -r ${SAMPLE}_*_trim.fastq.gz --unpaired ${SAMPLE}_*_BothSingle.fastq.gz -t_aa /home/rebecca.clement/90day_aphid/raw_data/cox1_mtdna_endos.fasta --cpu 20 --prefix ${SAMPLE}_COI --diamond
