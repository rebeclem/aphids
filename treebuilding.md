...
5) In the Analysis directory, align the amino acid files using the [mafft script](scripts/mafft.sh) and `sbatch ../../scripts/mafft.sh` (takes about 30min). Check for empty files using `find *align -empty`.
